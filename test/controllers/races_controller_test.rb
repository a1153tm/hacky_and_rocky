...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { end_date: @race.end_date, etype: @race.etype, grade: @race.grade, name: @race.name, start_date: @race.start_date }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { end_date: @race.end_date, etype: @race.etype, grade: @race.grade, name: @race.name, start_date: @race.start_date }
    assert_redirected_to race_path(assigns(:race))
  end
